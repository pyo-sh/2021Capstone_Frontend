...
import { StyleSheet, View, Animated, TextInput, TouchableOpacity } from "react-native";
...
const SearchInput = props => {
	...
	return (
		<View style={[styleSheet.wrapper, style ?? {}]}>
			<TextInput
			...
			<View style={styleSheet.interactive}>
				{text ? (
					<SlideRightView style={{ position: "absolute", zIndex: 3 }}>
						<TouchableOpacity onPress={onSubmitEditing} index={1}>
							<SearchIcon />
						</TouchableOpacity>
					</SlideRightView>
				) : (
